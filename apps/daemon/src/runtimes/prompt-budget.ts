...
// before the child reads them, leaking secrets whenever the prompt
// mentions an env-var name.
...
// (a hand-built release or any other non-shim install path).
// `createCommandInvocation` does *not* wrap the
