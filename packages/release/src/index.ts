...
const descriptors: Record<ReleaseChannel, ReleaseChannelDescriptor> = {
  beta: {
    appId: "com.akoppcode.zerotwo.beta",
    baseVersionField: "baseVersion",
    channel: "beta",
    displayLabel: "Beta",
  ...
  betas: {
    appId: "com.akoppcode.zerotwo.betas",
    baseVersionField: "baseVersion",
    channel: "betas",
    counterField: "releaseNumber",
    displayLabel: "Betas",
  ...
  prerelease: {
    appId: "com.akoppcode.zerotwo.prerelease",
    baseVersionField: "baseVersion",
    channel: "prerelease",
    counterField: "releaseNumber",
  ...
  preview: {
    appId: "com.akoppcode.zerotwo.preview",
    baseVersionField: "baseVersion",
    channel: "preview",
    counterField: "releaseNumber",
